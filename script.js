...
const UPLOAD_BASE_URL = 'https://speech-backend-lo07.onrender.com';
let currentStep = 0;
...
demographicsForm.addEventListener('submit', async (event) => {
    ...
    // Handle exact formal tool - only send if formal_assessment_tool_used was 'yes' AND parent section was visible
